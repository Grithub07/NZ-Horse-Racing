...
namespace NZ_Horse_Racing {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Username, string Password, string Role) {
...
namespace NZ_Horse_Racing.EmployeesDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Employees` WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `Username` IS N" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`Username`, `Password`, `Role`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Employees` SET `Username` = ?, `Password` = ?, `Role` = ? WHERE ((`Employ" +
                "eeID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 " +
                "AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Role` IS NULL) OR " +
                "(`Role` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NZ_Horse_Racing.Properties.Settings.Default.EmployeesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Username, [Password], Role FROM Employees";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT EmployeeID, Username, [Password], Role FROM Employees WHERE [Username] = ?" +
                " AND [Password] = ?";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Username", global::System.Data.OleDb.OleDbType.WChar, 30, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Username", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Password", global::System.Data.OleDb.OleDbType.WChar, 30, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Password", global::System.Data.DataRowVersion.Current, false, null));
        }
        ...
        public virtual EmployeesDataSet.EmployeesDataTable GetDataByUsernamePassword(string Username, string Password) {
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_Username, string Original_Password, string Original_Role) {
        ...
        public virtual int Update(string Username, string Password, string Role, int Original_EmployeeID, string Original_Username, string Original_Password, string Original_Role) {
            if ((Username == null)) {
